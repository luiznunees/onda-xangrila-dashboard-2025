...
const Marujos = () => {
  ...
  const { data: marujos, isLoading, refetch } = useQuery({
    queryKey: ['marujos'],
  ...
  const handleDelete = async (id: string) => {
    try {
      ...
      console.error('Erro ao excluir marujo:', error);
      toast({
        title: "Erro ao excluir",
        description: "Não foi possível excluir o marujo.",
        variant: "destructive"
      });
      throw error;
    }
            ...
            {isLoading ? (
              ...
              <DataTable 
                ...
                detailFields={[
                  ...
                  { label: 'Onda', accessor: 'onda_onde',
                    render: (value, row) => `${value} ${row.onda_numero}` },
